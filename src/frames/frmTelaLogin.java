...
public class frmTelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LogoBibliotecaMenor.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // EVENTO DE CLIQUE AO BOTÃO ENTRAR
        ...
        try {
            ...
            String sql = "SELECT * FROM login WHERE username LIKE BINARY '" + login.getUsuario() + "' AND senha LIKE BINARY md5('" + login.getSenha() +"');";
            ...
            if (rs.next()){
                ...
                telaInicial.setLoginUsuario(id);
                telaInicial.setVisible(true);
                setVisible(false);
            }
            else{
                JOptionPane.showMessageDialog(null, "Usuário incorreto ou senha incorreta!", "ERRO", JOptionPane.ERROR_MESSAGE);
                jTextField1.setText("");
